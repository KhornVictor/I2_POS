...
void admin_display_user_table(Admin_List* list) {
    ...
    while (temp != NULL) {
        if (temp -> role == "admin") cout << GREEN;
        else if (temp -> role == "customer") cout << YELLOW;
        else if (temp -> role == "manager") cout << RED;
        else cout << BLUE;
        cout << left
             << setw(8)  << number
             << setw(20) << temp->name
    ...
    while (temporary != NULL) {
        if (temporary -> role == role){
            cout << left
                 ...
                 << setw(25) << temporary -> email
                 << setw(15) << temporary -> password
                 << endl;
...
void admin_check_user_display_menu(Admin_List* list){
    ...
    while(option != 8){
        ...
        switch (option){
            ...
            case 3:system("cls");admin_check_user_display_role_menu(list, "admin");break;
            case 4:system("cls");admin_check_user_display_role_menu(list, "manager");break;
            case 5:system("cls");admin_check_user_display_role_menu(list, "customer");break;
            case 6:system("cls");admin_check_user_display_role_menu(list, "cashier");break;
